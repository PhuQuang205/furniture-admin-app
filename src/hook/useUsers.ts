...
export const useUsers = () => {
    ...
    // Fetch users
    const fetchUsers = async (pageNum = page, search?: string, sortField: string = "id",
    ...
    const deleteUser = useCallback(async (id: number) => {
        try {
            setLoading(true);
            await userService.deleteUser(id); // gọi service delete
            // Cập nhật state local ngay sau khi xóa
